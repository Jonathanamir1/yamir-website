	...
	return (
		<section className='grid grid-cols-2 grid-rows-3 h-[80vh] w-full relative bg-hero'>
			...
			<div className='flex flex-col justify-start ml-64 mt-20 relative z-10 row-start-2 col-start-1'>
				...
				<h3 className='text-l font-extrabold text-gray font-raleway w-full pt-1'>
				...
				<div className='flex gap-4 mt-16'>
					...
					>
						<Image
							...
							width={48}
							height={48}
							className='bg-icon p-2 mx-4 my-1 shadow-'
						/>{' '}
					</Link>
					{/* Reduced size and padding */}
					<Link
						href='https://github.com/Jonathanamir1'
						target='_blank'
						rel='noopener noreferrer'
					>
						<Image
							...
							width={48}
							height={48}
							className='bg-icon p-2 mx-4 my-1 shadow-xl'
						/>{' '}
					</Link>
					{/* Reduced size and padding */}
					<Link
						href='https://www.linkedin.com/in/yamir1/'
						target='_blank'
						rel='noopener noreferrer'
					>
						<Image
